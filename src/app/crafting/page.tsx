...
export const metadata: Metadata = {
  title: 'Scars of Honor Crafting Simulator | ScarsHQ',
...
export default function CraftingPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      <h1 className="font-heading text-3xl md:text-4xl text-honor-gold mb-4">Scars of Honor Crafting Simulator</h1>
