...
// Redirects human visitors to /talents/[lastClass]?pick=true so the class
// picker modal opens. Search engines don't execute this — they index the
// server-rendered landing content alongside.
