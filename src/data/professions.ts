...
export const professions: Profession[] = [
  ...
  },
  {
    ...
    name: 'Woodcutting',
    type: 'Gathering',
    description: 'Fell trees and gather wood for crafting and enchanting.',
    details: 'Different trees grow across Aragon. Oak and birch are common, while ironwood and eldertree only grow in specific zones. Woodcutting features a rhythmic chopping minigame for bonus yield.',
  ...
  },
  {
    ...
    details: 'Leatherworkers produce medium armor worn by rangers, assassins, and druids. They also craft bags and bracers. The tanning process features a stretching minigame that determines flexibility and durability bonuses.',
